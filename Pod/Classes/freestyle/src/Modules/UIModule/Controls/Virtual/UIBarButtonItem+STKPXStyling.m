...
//
//  UIBarButtonItem+STKPXStyling.m
//  Pixate
//
...
void STKPXForceLoadUIBarButtonItemPXStyling() {}

@implementation UIBarButtonItem (STKPXStyling)
...
+ (STKPXDeclarationHandlerBlock) TintColorDeclarationHandlerBlock:(UIBarButtonItem *)target
{
