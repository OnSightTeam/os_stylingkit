...
{
    STKPXEllipticalArc *arc = [[STKPXEllipticalArc alloc] initWithCx:x cy:y radiusX:radiusX radiusY:radiusY startingAngle:startAngle endingAngle:endAngle];
...
@implementation STKPXEllipticalArc
{
    CGFloat cx_;
    CGFloat cy_;
    CGFloat a_;
