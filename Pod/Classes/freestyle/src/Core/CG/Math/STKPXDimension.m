...
{
    return [[STKPXDimension alloc] initWithNumber:number withDimension:dimension];
}
...
- (STKPXDimension *)degrees
{
    ...
    return [STKPXDimension dimensionWithNumber:result withDimension:@"deg"];
}

- (STKPXDimension *)points
{
    CGFloat result = 0.0;
    ...
    return [STKPXDimension dimensionWithNumber:result withDimension:@"pt"];
}

- (STKPXDimension *)radians
{
    CGFloat result = 0.0;
    ...
    return [STKPXDimension dimensionWithNumber:result withDimension:@"rad"];
}
