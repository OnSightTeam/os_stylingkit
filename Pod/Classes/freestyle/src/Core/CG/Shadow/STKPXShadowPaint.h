...
/**
 *  The STKPXShadowPaint protocol specifies the properties and methods required for a class to be used for shadowing of a
 *  contour
 */
@protocol STKPXShadowPaint <NSObject>
