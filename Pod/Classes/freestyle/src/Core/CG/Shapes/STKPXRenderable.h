...
/**
 *  The STKPXRenderable protocol declares properties needed when describing the structure of content rendered to a
 *  CGContext.
 */
@protocol STKPXRenderable <NSObject>

/**
 *  A property indicating the STKPXRenderable that this shape belongs to
 */
@property (nonatomic, strong) id<STKPXRenderable> parent;
