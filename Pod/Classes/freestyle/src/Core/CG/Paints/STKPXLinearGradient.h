...
typedef enum {
    STKPXLinearGradientDirectionToTop,
    STKPXLinearGradientDirectionToTopRight,
    STKPXLinearGradientDirectionToRight,
    STKPXLinearGradientDirectionToBottomRight,
    STKPXLinearGradientDirectionToBottom,
    STKPXLinearGradientDirectionToBottomLeft,
    STKPXLinearGradientDirectionToLeft,
    STKPXLinearGradientDirectionToTopLeft
} STKPXLinearGradientDirection;

/**
 *  STKPXLinearGradient is an implementation of a linear gradient. Linear gradients may be specified by an angle, or by two
 *  user-defined points.
 */
@interface STKPXLinearGradient : STKPXGradient
 ...
 */
@property (nonatomic) STKPXLinearGradientDirection gradientDirection;
