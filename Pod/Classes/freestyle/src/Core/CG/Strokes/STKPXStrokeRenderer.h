...
/**
 *  The STKPXStrokeRenderer protocol specifies a method that a class must implement if it is to be used to render a stroke
 *  on a contour.
 */
@protocol STKPXStrokeRenderer <NSObject>
