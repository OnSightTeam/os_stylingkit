...
/**
 *  STKPXStrokeStroke is an experimental class used to stroke the path of a path generated by another STKPXStrokeRenderer.
 */
@interface STKPXStrokeStroke : NSObject <STKPXStrokeRenderer>
 ...
 *  stroke of a stroke
 */
@property (nonatomic, strong) STKPXStroke *strokeEffect;

/**
 *  The stroke to apply once the stroke effect CGPath has been generated.
 */
@property (nonatomic, strong) id<STKPXStrokeRenderer> strokeToApply;
