...
STKPXVersionType STKPXVersionFromObject(id value)
{
    ...
    return STKPXVersionFromString(stringValue);
}

STKPXVersionType STKPXVersionFromString(NSString* vString)
{
    STKPXVersionType result = { -1, -1, -1 };
...
NSInteger _PXVersionCompare(STKPXVersionType v1, STKPXVersionType v2)
{
...
{
    return STKPXVersionFromString( [UIDevice currentDevice].systemVersion );
}
...
STKPXScreenRatioType STKPXScreenRatioFromObject(id object)
{
    if ([object isKindOfClass:[NSString class]]) {
        return STKPXScreenRatioFromString( (NSString*)object );
    }
...
STKPXScreenRatioType STKPXScreenRatioFromCGSize(CGSize size)
{
    STKPXScreenRatioType result =  0;
...
STKPXScreenRatioType STKPXScreenRatioCurrentSystem()
{
    ...
    return STKPXScreenRatioFromCGSize(mainScreenBounds.size);
}
