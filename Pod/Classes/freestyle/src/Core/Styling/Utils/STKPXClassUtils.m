...
@implementation STKPXClassUtils
...
+ (void)emitProtocols:(Class)c withSourceWriter:(STKPXSourceWriter *)writer
{
    // emit protocols
...
+ (void)emitAddress:(Class)c withSourceWriter:(STKPXSourceWriter *)writer
{
...
+ (void)emitVersion:(Class)c withSourceWriter:(STKPXSourceWriter *)writer
{
    // emit class version
    [writer printIndent];
...
+ (void)emitIvars:(Class)c withSourceWriter:(STKPXSourceWriter *)writer
{
    // emit ivars
    unsigned int count = 0;
...
+ (void)emitProperties:(Class)c withSourceWriter:(STKPXSourceWriter *)writer
{
    // emit properties
    unsigned int count = 0;
...
+ (void)emitMethods:(Class)c withSourceWriter:(STKPXSourceWriter *)writer
{
    // emit methods
    unsigned int count = 0;
