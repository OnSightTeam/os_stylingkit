...
+ (void)recursiveDescription:(UIView *)view withSourceWriter:(STKPXSourceWriter *)writer
{
...
+ (void)emitLayer:(CALayer *)layer withSourceWriter:(STKPXSourceWriter *)writer
{
...
+ (void)emitAttributes:(NSObject *)view withSourceWriter:(STKPXSourceWriter *)writer
{
    // emit type
...
+ (void)emitAttributeName:(NSString *)name value:(NSString *)value withSourceWriter:(STKPXSourceWriter *)writer
{
    [writer print:@" "];
    [writer print:name];
    [writer print:@"=\""];
