...
@implementation STKPXStylesheetLexeme
{
    NSUInteger flags_;
}
...
{
    return [[STKPXStylesheetLexeme alloc] initWithType:type withRange:NSMakeRange(NSNotFound, 0) withValue:nil];
}

+ (instancetype)lexemeWithType:(int)type withRange:(NSRange)range
{
    return [[STKPXStylesheetLexeme alloc] initWithType:type withRange:range withValue:nil];
}

+ (instancetype)lexemeWithType:(int)type withValue:(id)value
{
    return [[STKPXStylesheetLexeme alloc] initWithType:type withRange:NSMakeRange(NSNotFound, 0) withValue:value];
}

+ (instancetype)lexemeWithType:(int)type withRange:(NSRange)range withValue:(id)value
{
    return [[STKPXStylesheetLexeme alloc] initWithType:type withRange:range withValue:value];
}
