...
@implementation STKPXDeclarationContainer
{
...
- (void)addDeclaration:(STKPXDeclaration *)declaration
{
    if (declaration != nil)
    {
        ...
        // check for dups
        STKPXDeclaration *addedDeclaration = [self declarationForName:declaration.name];
...
- (void)removeDeclaration:(STKPXDeclaration *)declaration
{
...
- (STKPXDeclaration *)declarationForName:(NSString *)name
{
    STKPXDeclaration *result = nil;

    for (STKPXDeclaration *declaration in declarations_)
    {
