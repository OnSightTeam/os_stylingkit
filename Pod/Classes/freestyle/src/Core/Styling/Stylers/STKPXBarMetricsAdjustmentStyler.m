...
@implementation STKPXBarMetricsAdjustmentStyler
...
- (NSDictionary *)declarationHandlers
{
    ...
    dispatch_once(&onceToken, ^{
        handlers = @{
            @"vertical-position-adjustment" : ^(STKPXDeclaration *declaration, STKPXStylerContext *context) {
                context.barMetricsVerticalOffset = declaration.lengthValue;
            },
        };
    });
