...
/**
 *  The STKPXStyler protocol is a collection of methods used to apply styles defined in a STKPXRuleSet to a STKPXStyleable
 ...
 *  calcuations.
 *
 *  The apply styles phase creates any instances needed for styling and applies these to the STKPXStyleable instance.
 */
@protocol STKPXStyler <NSObject>
