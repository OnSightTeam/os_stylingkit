...
@interface STKPXCacheManager : NSObject
...
+ (STKPXStyleTreeInfo *)styleTreeInfoForKey:(NSString *)key;
+ (void)setStyleTreeInfo:(STKPXStyleTreeInfo *)styleTreeInfo forKey:(NSString *)key;
