 ...
 */
typedef NS_ENUM(unsigned int, STKPXStylingMode)
{
    STKPXStylingUndefined = 0, // undefined
    STKPXStylingNormal,        // normal
    STKPXStylingNone           // none
...
/**
 *  The STKPXStyleable protocol defines a set of properties and methods needed in order to style a given object.
 */
@protocol STKPXStyleable <NSObject>
...
/**
 * The styling mode of the styleable as defined by the STKPXStylingMode enumeration.
 */
 ...
 */
- (id<STKPXStyleable>)styleableForPseudoElement:(NSString *)pseudoElement;
