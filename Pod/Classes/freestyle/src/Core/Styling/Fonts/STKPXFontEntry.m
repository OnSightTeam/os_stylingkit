...
+ (NSArray *)fontEntriesForFamily:(NSString *)family
{
    ...
    {
        [infos addObject:[[STKPXFontEntry alloc] initWithFontFamily:family fontName:fontName]];
    }
...
{
    // sort by stretch
    NSArray *sortedInfos = [entries sortedArrayUsingComparator:^NSComparisonResult(STKPXFontEntry *obj1, STKPXFontEntry *obj2) {
    ...
    {
        STKPXFontEntry *first = sortedInfos[0];
        NSInteger diff = first.stretch - fontStretch;

        [sortedInfos enumerateObjectsUsingBlock:^(STKPXFontEntry *obj, NSUInteger idx, BOOL *stop) {
...
+ (NSArray *)filterEntries:(NSArray *)entries byStyle:(NSString *)style
{
    ...
    NSArray *sortedItalics = [entries sortedArrayUsingComparator:^NSComparisonResult(STKPXFontEntry *obj1, STKPXFontEntry *obj2) {
    ...
    {
        STKPXFontEntry *first = sortedItalics[0];
        NSInteger diff = styleToInteger(first.style) - styleValue;

        [sortedItalics enumerateObjectsUsingBlock:^(STKPXFontEntry *obj, NSUInteger idx, BOOL *stop) {
