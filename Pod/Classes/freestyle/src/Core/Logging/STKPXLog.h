...
#define STKPX_LOGGING STK_LOGGING

# import <CocoaLumberjack/CocoaLumberjack.h>

static const DDLogLevel LogLevelDefault = DDLogLevelWarning;

# define STKPX_DEFINE_FILE_LOG_LEVEL static const DDLogLevel ddLogLevel = LogLevelDefault;
...
# define STK_DEFINE_CLASS_LOG_LEVEL
# define STKPX_DEFINE_FILE_LOG_LEVEL
