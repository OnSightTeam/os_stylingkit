...
@implementation STKPXWordMatcher
{
...
{
    STKPXStylesheetLexeme *match = [super createLexemeWithString:aString withRange:aRange];
    ...
    if (wordMap && match)
    {
        ...
        if (type)
        {
            result = [STKPXStylesheetLexeme lexemeWithType:type.intValue withRange:match.range withValue:text];
        }
    }
